...
<s:url id="urlPositionGeographiqueRecherche" action="search" namespace="/routingConstraint">
...
<div class="panel">
  <s:form cssClass="panelDataInnerForm" action="searchResults" namespace="/routingConstraint">
